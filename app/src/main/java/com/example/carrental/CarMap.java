...
public class CarMap extends AppCompatActivity implements OnMapReadyCallback,  com.google.android.gms.location.LocationListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        //LocationServices.FusedLocationApi.requestLocationUpdates(mSignInOptions, mLocationRequest, this);
        LocationServices.getFusedLocationProviderClient(this).requestLocationUpdates(mLocationRequest, mSignInOptions, this);
